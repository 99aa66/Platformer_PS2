...
public class Head : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        {
            rb.MoveRotation(Mathf.LerpAngle(rb.rotation, restingAngle, 5000 * Time.deltaTime));  // Si le bouton gauche de la souris n'est pas enfoncé, la tête revient à sa position
        }
    }
}